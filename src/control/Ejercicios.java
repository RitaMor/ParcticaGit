...
*/
	public int[] generaEstadisticaAparicion(int n, int inferior, int superior) {
		...
		for (int i = 0; i < n; i++) {
			...
			resultado[numero - 1]++;
			System.out.println(+i+".- Ejer1. El número "+numero+" lleva "+resultado[numero-1]+" repeticiones");
	...
	public int[] generaEstadisticaAparicion1(int n, int inferior, int superior) {
		...
		for (int i = 0; i < n; i++) {
			...
			System.out.println(i+".- Ejer2. El número "+numero[i]+": lleva "+resultado[numero[i]-1]+" apariciones");
		}
